...
license_head_AnonymousOrg = "Copyright 2024 Anonymous"
license_head_AnonymousOrg_25 = "Copyright 2025 Anonymous"
...
license_headers = [
    license_head_AnonymousOrg,
    license_head_AnonymousOrg_25,
    license_head_prime,
