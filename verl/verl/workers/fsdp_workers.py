...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def _build_model_optimizer(
        ...
        # TODO(anonymous): 1. support create from random initialized model. 2. Support init with FSDP directly
        ...
        with init_context(), warnings.catch_warnings():
            ...
            # some parameters may not in torch_dtype. TODO(anonymous) remove this after we switch to fsdp2
        ...
        if self._is_rollout and self.config.rollout.name == "hf":
            # TODO(anonymous, shengguangming) fix me. Current, auto_wrap_policy causes HFRollout to hang in Gemma
    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        if rollout_name == "hf":
            ...
            # NOTE(anonymous): Due to recent fp8 support in SGLang. Now importing any symbol relate to
    ...
    def update_actor(self, data: DataProto):
        ...
        with self.ulysses_sharding_manager:
            ...
            with Timer(name="update_policy", logger=None) as timer:
                if data.meta_info.get("cttrl_enable_projection", False):
                    metrics = self.actor.update_policy_cttrl(data=data)
                else:
