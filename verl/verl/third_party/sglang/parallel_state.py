...
# NOTE(anonymous): this function is for megatron
...
# NOTE(anonymous): After init SGLang rollout using class EngineFragment, user should always remember to call
...
# NOTE(anonymous): the SGLang version using _TP instead of ps._TP
...
# NOTE(anonymous): In the vllm version parallel_state.py. verl created its own _TP and _PP as verl want to use
