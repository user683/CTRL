...
class AdvantageEstimator(str, Enum):
    ...
    Note(anonymous): this enum class is immutable after creation. Extending this
...
def compute_policy_loss_clip_cov(
    ...
    Adapted from
    https://github.com/anonymous-org/Entropy-Mechanism-of-RL/blob/main/verl/trainer/ppo/core_algos.py
