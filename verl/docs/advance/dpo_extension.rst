...
pre-implemented specific dispatch and collect methods,in `decorator.py <https://github.com/anonymous-org/verl/blob/main/verl/single_controller/base/decorator.py>`_, which can be directly used to wrap the computations.
...
``DataProto`` is in `protocol.py <https://github.com/anonymous-org/verl/blob/main/verl/protocol.py>`_.
...
similar as in `ray_trainer.py <https://github.com/anonymous-org/verl/blob/main/verl/trainer/ppo/ray_trainer.py>`_.
