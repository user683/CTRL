...
`megatron_vllm.py <https://github.com/anonymous-org/verl/blob/main/verl/workers/sharding_manager/megatron_vllm.py>`_
and `megatron_sglang.py <https://github.com/anonymous-org/verl/blob/main/verl/workers/sharding_manager/megatron_sglang.py>`_.
...
(i.e., transfer protocols) can be found in `decorator.py <https://github.com/anonymous-org/verl/blob/main/verl/single_controller/base/decorator.py>`_.
...
kinds of models, please refer to Anonymous.
