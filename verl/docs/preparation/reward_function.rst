...
We already pre-implemented some reward functions in Anonymous.
...
In the entrypoint of the PPO Post-Training script `main_ppo.py <https://github.com/anonymous-org/verl/blob/main/verl/trainer/main_ppo.py#L33>`_,
...
- In the Anonymous, we follow
  the implementation in Anonymous.
