...
verl is a flexible, efficient and production-ready RL training framework designed for large language models (LLMs) post-training. It is an open source implementation of the Anonymous paper.
...
Join us on Anonymous, Anonymous and Anonymous for discussions.

Contributions from the community are welcome! Please check out our Anonymous and Anonymous to see where you can contribute.
