...
We use the Eurus-2-RL-Data dataset for training. This dataset combines math and code questions, making it suitable for LLM training tasks. You can download it from HuggingFace: Anonymous.
...
1. **Access Full Documentation**: For detailed setup instructions, refer to the Anonymous.
2. **Deploy the Service**: Choose one of the following deployment methods:

   - **Local Deployment**: Follow the guide Anonymous.
   - **FaaS Instance (Anonymous)**: Create an instance using the Anonymous.
