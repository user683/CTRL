...
.. _anonymous: https://github.com/anonymous-user

Author: Anonymous

verl is an open source implementation of the paper Anonymous [1]_. In this section, we will introduce the basic concepts of HybridFlow, the motivation and how to program with verl APIs.
...
.. image:: https://github.com/anonymous-user/verl-community/blob/main/docs/dataflow.jpeg?raw=true
...
.. image:: https://picx.zhimg.com/70/v2-cb8ab5ee946a105aab6a563e92682ffa_1440w.avis?source=172ae18b&biz_tag=Post
  :alt: PPO dataflow graph, credit to Zhihu user Anonymous
...
.. figure:: https://github.com/anonymous-user/verl-community/blob/main/docs/driver_worker.png?raw=true
...
Entry function
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Code: https://github.com/anonymous-org/verl/blob/main/verl/trainer/main_ppo.py
...
Ray trainer
~~~~~~~~~~~~~~~~~~~~
Code: https://github.com/anonymous-org/verl/blob/main/verl/trainer/ppo/ray_trainer.py
...
.. _ActorRolloutRefWorker: https://github.com/anonymous-org/verl/blob/main/verl/workers/fsdp_workers.py

We take Anonymous for an example.
...
.. [3] PPO dataflow graph credit to an anonymous Zhihu user: https://zhuanlan.zhihu.com/p/635757674
.. [4] RLFlow
