...
We selected Anonymous_ as the initial backend for
...
**Source:**
`fsdp_workers.py <https://github.com/anonymous-org/verl/blob/c59ab2f4788f9a910836a9f2f53dcdb62dfa314e/verl/workers/fsdp_workers.py#L528>`__
...
**Source:**
`decorator.py <https://github.com/anonymous-org/verl/blob/c59ab2f4788f9a910836a9f2f53dcdb62dfa314e/verl/single_controller/base/decorator.py#L411>`__
...
**Source:**
`main_generation.py <https://github.com/anonymous-org/verl/blob/4ae9a0fdab229f75f080e9478807783ed4c97154/verl/trainer/main_generation.py#L82>`__
...
1. Worker instances (Ray actors) are created:
   `RayWorkerGroup._init_with_resource_pool <https://github.com/anonymous-org/verl/blob/c59ab2f4788f9a910836a9f2f53dcdb62dfa314e/verl/single_controller/ray/base.py#L211>`__
2. Methods decorated with ``@register`` are bound to ``RayWorkerGroup``:
   `RayWorkerGroup._bind_worker_method <https://github.com/anonymous-org/verl/blob/c59ab2f4788f9a910836a9f2f53dcdb62dfa314e/verl/single_controller/ray/base.py#L214>`__

.. figure:: https://github.com/anonymous-user/verl-community/blob/main/docs/worker_group_init.png?raw=true
...
**Key function:**
`WorkerGroup._bind_worker_method <https://github.com/anonymous-org/verl/blob/c59ab2f4788f9a910836a9f2f53dcdb62dfa314e/verl/single_controller/base/worker_group.py#L143>`__
...
.. figure:: https://github.com/anonymous-user/verl-community/blob/main/docs/call_generate_sequences.png?raw=true
