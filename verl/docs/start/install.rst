...
For SGLang with FSDP, please use ``anonymous-user/verl-sglang:ngc-th2.6.0-cu126-sglang0.4.6.post5`` which is provided by SGLang RL Group.
...
.. code:: bash
    ...
    git clone https://github.com/anonymous-org/verl && cd verl
...
.. code:: bash
   ...
   git clone https://github.com/anonymous-org/verl.git
   cd verl
...
If you encounter any issues in using AMD GPUs running verl, feel free to contact me - Anonymous.

Find the docker for AMD ROCm: `docker/Dockerfile.rocm <https://github.com/anonymous-org/verl/blob/main/docker/Dockerfile.rocm>`_
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
