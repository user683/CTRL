...
.. _anonymous-user: https://github.com/anonymous-user
...
.. image:: https://github.com/anonymous-user/verl-community/blob/main/docs/ray/head.png?raw=true

2. Start worker node with ``ray start --address=<address>`` you get above.

.. image:: https://github.com/anonymous-user/verl-community/blob/main/docs/ray/worker.png?raw=true

3. Now you should see the cluster have 2 nodes with ``ray status``.

.. image:: https://github.com/anonymous-user/verl-community/blob/main/docs/ray/status.png?raw=true
...
.. image:: https://github.com/anonymous-user/verl-community/blob/main/docs/ray/overview.png?raw=true
...
.. image:: https://github.com/anonymous-user/verl-community/blob/main/docs/ray/submit.png?raw=true
...
.. image:: https://github.com/anonymous-user/verl-community/blob/main/docs/ray/job.png?raw=true
.. image:: https://github.com/anonymous-user/verl-community/blob/main/docs/ray/job_detail.png?raw=true
...
Prerequisite
~~~~~~~~~~~~
Once dstack is Anonymous, initialize the directory as a repo with ``dstack init``. 
...
Before submitting distributed training jobs, create a `dstack` Anonymous.
...
.. code-block:: yaml
    ...
    commands:
        - git clone https://github.com/anonymous-org/verl
        - cd verl
...
For more details on how `dstack` works, check out its Anonymous.
...
1. Starting with Ray 2.39, Anyscale has introduced the Anonymous VSCode extension. Follow the extension’s installation instructions, then add your cluster using the dashboard URL you obtained earlier.

   .. image:: https://github.com/anonymous-user/verl-community/blob/main/docs/ray/debugger.png?raw=true
...
Legacy Ray Debugger
~~~~~~~~~~~~~~~~~~~
1. Ray has a builtin legacy Anonymous that allows you to debug your distributed applications. To enable debugger, start ray cluster with ``RAY_DEBUG=legacy`` and ``--ray-debugger-external``.
...
.. image:: https://github.com/anonymous-user/verl-community/blob/main/docs/ray/legacy.png?raw=true
...
If you encounter any issues in using AMD GPUs running verl, please contact Anonymous.
