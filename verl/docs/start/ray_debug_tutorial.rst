...
2. Prerequisites.
   ...
   .. image:: https://github.com/anonymous-user/verl-community/blob/main/docs/ray/readme.png?raw=true
...
6. Attaching to a Breakpoint.
 ...
 Once the process hits the first `breakpoint()`, click the Ray Distributed Debugger icon in the VSCode sidebar to attach the debugger.
   ...
   .. image:: https://github.com/anonymous-user/verl-community/blob/main/docs/ray/launch.png?raw=true
...
7. Debugging With Multiple breakpoint().
   ...
   .. image:: https://github.com/anonymous-user/verl-community/blob/main/docs/ray/disconnect.png?raw=true
