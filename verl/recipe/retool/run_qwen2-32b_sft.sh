...
TRAIN_DATA=$DATA_ROOT/dataset/anonymous-user/ReTool-SFT/data/train-00000-of-00001.parquet
EVAL_DATA=$DATA_ROOT/dataset/anonymous-user/ReTool-SFT/data/train-00000-of-00001.parquet
...
torchrun --nnodes=$ARNOLD_WORKER_NUM \
    ...
    trainer.project_name=anonymous-user-multiturn-sft \
